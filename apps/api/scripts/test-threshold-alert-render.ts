 ...
 * email sent) to verify the multi-tool layout, and separately exercises the
 * grouping logic in checkThresholdAlerts() against synthetic data to confirm
 * two tools sharing a recipient produce exactly one grouped call.
 */
...
async function main() {
  ...
  console.log('Wrote scratch/threshold-alert-single.html and scratch/threshold-alert-multi.html');
